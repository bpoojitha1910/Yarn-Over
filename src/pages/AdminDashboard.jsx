...
export default function AdminDashboard({ onNavigate }) {
  ...
  // Mobile drawer state for screens < 1024px
  ...
  return (
    ...
    >
      ...
      {/* TOP HEADER */}
      <div style={{ position: "relative", zIndex: 2, marginBottom: "12px", flexShrink: 0, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <div>
          <button
        ...
        {/* Collapsible Mobile Drawer Hamburger Trigger */}
        <button
      ...
      {/* TOP SECTION: Analytics Cards (Collapsible on mobile via drawer class) */}
      <div
        className="admin-collapsible-nav"
        style={{
          position: "relative",
          zIndex: 2,
          display: "grid",
